		...
		-->
			...
			<div class="carousel-inner">
				<div class="item active">
					<img class="desktop" src="http://<?php echo $_SERVER['HTTP_HOST']; ?>/mobile/img/hero-1-470.jpg" alt="First slide">
					<img class="mobile" src="http://<?php echo $_SERVER['HTTP_HOST']; ?>/mobile/img/hero-1-mobile.jpg" alt="First slide">
				</div>
				<div class="item">
					<img class="desktop" src="http://<?php echo $_SERVER['HTTP_HOST']; ?>/mobile/img/hero-2-470.jpg" alt="Second slide">
					<img class="mobile" src="http://<?php echo $_SERVER['HTTP_HOST']; ?>/mobile/img/hero-2-mobile.jpg" alt="First slide">
				</div>
				<div class="item">
					<img class="desktop" src="http://<?php echo $_SERVER['HTTP_HOST']; ?>/mobile/img/hero-3-470.jpg" alt="Third slide">
					<img class="mobile" src="http://<?php echo $_SERVER['HTTP_HOST']; ?>/mobile/img/hero-3-mobile.jpg" alt="First slide">
				</div>
				<div class="item">
					<img class="desktop" src="http://<?php echo $_SERVER['HTTP_HOST']; ?>/mobile/img/hero-4-470.jpg" alt="Fourth slide">
					<img class="mobile" src="http://<?php echo $_SERVER['HTTP_HOST']; ?>/mobile/img/hero-4-mobile.jpg" alt="First slide">
				</div>
			</div>
			<!-- Controls -->
	...
	<div class="row">
		...
		<div class="col-sm-10 col-sm-offset-1 col-xs-12">
			<div class="content-filter-header">
				<h1>Ano po ang maipaglilingkod namin sa inyo ? <button class="btn btn-danger toggle-filter">+</button>
				</h1>
			</div>
		</div>
	</div>
...
<div class="content-filter-xsMobile">
	<div class="content-filter-header-xsMobile">
		<div class="container">
			<div class="col-sm-10 col-sm-offset-1 col-xs-12">
				<div class="row">
...
<div class="divider">
	<img src="http://<?php echo $_SERVER['HTTP_HOST']; ?>/mobile/img/line-divider.png" alt="">
</div>
...
<div class="bills-payment">
	<div class="container">
		<div class="row">
			<div class="col-sm-7">
				<img class="img-responsive" src="http://<?php echo $_SERVER['HTTP_HOST']; ?>/mobile/img/bills-payment.png" alt="">
			</div>
			<div class="col-sm-5">
				<h2>Bills Payment</h2>
		...
		<div class="row">
			<div class="col-sm-12">
				<ul>
					...
					<li><a href="">Cash Card Withdrawal</a></li>
	...
	<div class="container">
		<div class="row">
			<div class="col-sm-6">
				...
				<div class="col-sm-6">
					<img class="img-responsive" src="http://<?php echo $_SERVER['HTTP_HOST']; ?>/mobile/img/withdrawal.png" alt="">
				</div>
			</div>
			<div class="col-sm-6">
				<div class="col-sm-6">
				...
				<div class="col-sm-6">
					<img class="img-responsive" src="http://<?php echo $_SERVER['HTTP_HOST']; ?>/mobile/img/money-changer.png" alt="">
				</div>
			</div>
		</div>
	</div>
...
<div class="e-loading">
	<div class="container">
		<div class="row">
			<div class="col-sm-5">
				<img class="img-responsive" src="http://<?php echo $_SERVER['HTTP_HOST']; ?>/mobile/img/e-loading.png" alt="">
			</div>
			<div class="col-sm-7">
				<h2>E-loading</h2>
...
<div class="insurance">
	<div class="container">
		<div class="row">
			<div class="col-sm-12">
				<h2>Insurance</h2>
				<img class="img-responsive" src="http://<?php echo $_SERVER['HTTP_HOST']; ?>/mobile/img/insurance.png" alt="">
