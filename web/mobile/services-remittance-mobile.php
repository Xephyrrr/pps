		...
		<div class="row">
			<div class="col sm-12">
				...
				<div class="col-md-5 col-md-offset-1 col-sm-8 col-sm-offset-2">
					<div class="col-md-5  col-md-1 loan-widget remittance-loan-widget-bg">
						<div class="row">
							<div class="col-md-12">
			...
			<div class="col-sm-12">
				...
				<div class="col-sm-12">
					<div class="col-sm-12">
						...
						<p>5) Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
							tempor incididunt ut labore et dolore magna aliqua. </p>
						<p class="carret col-sm-5 col-sm-offset-4">VIEW ALL<i class="fa fa-chevron-down chevron"></i></p>
					</div>
					<div class="col-sm-5">
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-12">
				...
				<p class="carret2 col-sm-4 col-sm-offset-5">VIEW ALL<i class="fa fa-chevron-down chevron"></i></p>
			</div>
